...
public class WriteStarRocksConfig extends StarRocksConfigBase {
    ...
    public static final String TEMPORARY_PARTITION_SUFFIX = "_tmp_created_by_sr_spark_connector_";

    public static final String TEMPORARY_TABLE_SUFFIX = "_tmp_created_by_sr_spark_connector_";
